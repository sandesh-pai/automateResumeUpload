...
public final class MyNaukriPage extends basePom{
	...
	{
		click(searchbtn, waitStrategy.PRESENCE, "searchBtn");
		return this;
	...
	{
		click(updateProfileBtn, waitStrategy.CLICKABLE, "updateProfileBtn");
		return this;
	}
	...
	{
		enterInput(attchcv, waitStrategy.PRESENCE, readproperty.getvalue(value), "resumeUploadfield");
	}
}
